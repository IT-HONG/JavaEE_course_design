    ...
    <tbody>
     <s:iterator value="newslist" id="news">
    	<tr class="odd">
            ...
            <td><s:property value="#news.publish_time"/></td>
            <td><s:property value="#news.source"/></td>
            <td><s:property value="#news.type.getType()"/></td>
            <td><s:a action="editInuputAction.action?id=%{#news.id}"><img src="images/edit.png" alt="" title="" border="0" /></s:a></td>
            <td><a href="news/deleteAction.action?id=<s:property value="#news.id"/> " onClick="delcfm()"><img src="images/trash.gif" alt="" title="" border="0" /></a></td>
        </tr>
         </s:iterator>  
    </tbody>
</table>
