...
%>
	...
	<img src="icon/insert.jpg"/><a href="CRM/ClientAdd.jsp" target="main">增加</a> 
	<img src="icon/look.jpg"/><a href="CRM/ClientDisp.jsp?id=<%=rs.getString(1) %>" target="main">查看</a> 
	<img src="icon/update.jpg"/><a href="CRM/Change.jsp?id=<%=rs.getString(1)%>">修改</a>
	<img src="icon/delete.jpg"/><a href="CRM/Delete.jsp?id=<%=rs.getString(1)%>">删除</a></td>
    </tr>
<%
	}
	rs.close();
