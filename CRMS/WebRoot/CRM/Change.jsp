...
<body> 
 <form method="post" action="/CRM/servlet/Change">
...
border="0">
  <tbody>
    ...
    <tr>
      ...
      <td width="83%" class="td_bg"><input type="text" name="cid" value="<%=rs.getString(1) %>"/></td>
    </tr>
    
    <tr>
      <td class="td_bg" width="17%" height="25">客户姓名<span class="TableRow2"></span></td>
      <td width="83%" class="td_bg"><input type="text" name="cname"  value="<%=rs.getString(2)%>"/></td>
    </tr>
    ...
    <tr>
      ...
      <td width="83%" class="td_bg"><input type="text" name="cadd" value="<%=rs.getString(3)%>"/></td>
    </tr>


    <tr>
      <td class="td_bg" width="17%" height="25">电话</td>
      <td class="td_bg" width="83%"><input type="text" name="ccall" value="<%=rs.getString(4)%>"/> </td>
    </tr>

	<tr>
      <td class="td_bg" width="17%" height="25">电子邮件</td>
      <td class="td_bg" width="83%"><input type="text" name="cmail" value="<%=rs.getString(5)%>"/></td>
    </tr>
	...
	<tr>
      ...
      <td class="td_bg" width="83%"><input type="text" name="linkman" value="<%=rs.getString(8)%>"/></td>
    </tr>
    
	<tr>
      <td class="td_bg" width="17%" height="25">客户等级</td>
      <td class="td_bg"><select name="level" ><option value="<%=rs.getString(9)%>" selected><%=rs.getString(9) %></option><option value="普通">普通</option><option value="高级">高级</option><option value="特殊">特殊</option></select></td>
    </tr>

	<tr>
      <td class="td_bg" width="17%" height="25">所属行业 </td>
      <td class="td_bg" width="83%"><input type="text" name="c_industry" value="<%=rs.getString(10)%>"/></td>
    </tr>
    
	<tr>
      <td class="td_bg" width="17%" height="25">城市</td>
      <td width="83%" class="td_bg">
      <select name="province" id="s1"><option value="<%=rs.getString(12)%> selected"><%=rs.getString(12) %></option></select>   
    <select name="city" id="s2">   
    <option value="<%=rs.getString(11)%> selected"><%=rs.getString(11) %></option>
    </select>   
    <script type="text/javascript">
    setup()
    </script>
	...
	<tr>
      ...
      <td width="83%" class="td_bg"><input type="text" name="bank" value="<%=rs.getString(13)%>"/></td>
    </tr>
	
	<tr>
      <td class="td_bg" width="17%" height="25">银行账号</td>
      <td width="83%" class="td_bg"><input type="text" name="bank_id" value="<%=rs.getString(14)%>"/></td>
    </tr>
	
	<tr>
      <td class="td_bg" width="17%" height="25">信用</td>
      <td width="83%" class="td_bg"><select name="credit"><option value="<%=rs.getString(15)%>" selected><%=rs.getString(15) %></option><option value="高">高</option><option value="正常">正常</option><option value="低">低</option></select></td>
    </tr>
	
	<tr>
      <td class="td_bg" width="17%" height="25">积分</td>
      <td width="83%" class="td_bg"><input type="text" name="integration" value="<%=rs.getString(16)%>"/></td>
    </tr>
	
	<tr>
      <td class="td_bg" width="17%" colspan="2"  height="25"><input type="submit" value="修改"/><input type="reset" value="重置"/></td>
    </tr>
